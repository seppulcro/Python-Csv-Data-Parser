...
cursor.execute('''CREATE TABLE inscritos(cod_inst text(10), cod_curso text(10), nome_inst text(100), nome_curso text(100), grau text(10), vagas_inicial number, colocados number, last_grade number, vagas_final number)''')
